...
return function(FyyUI)
	assert(FyyUI.Version == "0.13.5", "library version must identify the Lucide image property fix release")
	...
	assert(legacyConfig.Schema == "FyyUI.Config.v1" and legacyConfig.Version == "0.13.5", "zero-argument config export must retain the v1 contract")
	...
	assert(v2.Schema == "FyyUI.Config.v2" and v2.SchemaVersion == 2 and v2.Version == "0.13.5", "explicit v2 export must use the versioned JSON-safe envelope")
