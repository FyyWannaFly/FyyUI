...
v0.15.1 fixes the notification source syntax and makes demo loader compilation failures report their actual error instead of a generic line-1 nil call.
