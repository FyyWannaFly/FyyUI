...
v0.14.0 unifies card-backed component sizing and alignment, moves Dropdown and Slider controls into consistent right-side layouts, and corrects Collapsible child spacing and animation sizing.
